...
class Tracker:
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        team_1_full_frames = team_ball_control_till_frame[team_ball_control_till_frame == 1].shape[0]
        team_2_full_frames = team_ball_control_till_frame[team_ball_control_till_frame == 2].shape[0]

        team_1 = team_1_full_frames/(team_1_full_frames + team_2_full_frames)   
        team_2 = team_2_full_frames/(team_1_full_frames + team_2_full_frames)
